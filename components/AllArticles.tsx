...
const AllArticles = ({ blok }) => {
    ...
    // todo убрать index, сделать все в [...slug]

    // todo Сделать переключение между драфтом не таким странным (через эндпоинты сейчас)

    // todo Протестить хук деплоя, когда ограничение на паблиш уйдет. Изменить контент, запаблишить и увидеть в проде.
